...
def GB(df):
    ...
    def create_sequences(X, y, window_size=48, forecast_horizon=24):
        X_seq, y_seq = [], []
    ...
    X, y = create_sequences(X_data, y_data, window_size=48, forecast_horizon=24)
...
GB(pd.read_csv("Solar.csv", index_col=0))
